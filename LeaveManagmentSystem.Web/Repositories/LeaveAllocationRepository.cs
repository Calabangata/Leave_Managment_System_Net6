...
namespace LeaveManagmentSystem.Web.Repositories
{
    public class LeaveAllocationRepository : GenericRepository<LeaveAllocation>, ILeaveAllocationRepository
    {
        ...
        public LeaveAllocationRepository(ApplicationDbContext context, UserManager<Employee> userManager,
            ILeaveTypeRepository leaveTypeRepository, AutoMapper.IConfigurationProvider configurationProvider, IMapper mapper) : base(context)
        {
        ...
        public async Task<LeaveAllocationEditVM> GetEmpAllocation(int id)
        {
		...
		public async Task<bool> UpdateEmpAllocation(LeaveAllocationEditVM model)
		{
